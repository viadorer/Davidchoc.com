...
(function () {
  ...
  function init() {
    ...
    HubTools.initChecklist({
      storageKey: 'milionarem-proverka-dokumenty',
      ...
      doneClass: 'is-done',
      doneTarget: '.vy-check',
      gaEvent: 'milionarem_proverka_dokumenty'
    });
    ...
    HubTools.initChecklist({
      storageKey: 'milionarem-proverka-signaly',
    ...
    HubTools.initChecklist({
      storageKey: 'milionarem-proverka-technika',
      ...
      doneClass: 'is-done',
      doneTarget: '.vy-check',
      gaEvent: 'milionarem_proverka_technika'
    });
    ...
    HubTools.initFields({
      storageKey: 'milionarem-proverka-email',
    ...
    if (tlacitko) {
      tlacitko.addEventListener('click', function () {
        ...
        function hotovo() {
          ...
          if (window.gtag) {
            window.gtag('event', 'milionarem_email_svj', {
